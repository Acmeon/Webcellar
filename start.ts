...
program.name("webcellar")
       ...
       .option("--mode <modes...>", "execution mode for Webcellar: 'init' initializes, 'build' builds dependencies, 'run' starts the server, 'deinit' removes it; by default webcellar executes 'init' (if needed), 'build' (if needed) and then 'run'")
